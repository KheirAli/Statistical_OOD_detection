...
# CUDA_VISIBLE_DEVICES=5 python train_embedder.py --data_dir /data/akheirandish3/mvtec_ad/faces/extras --save_model models/pixel_autoencoder_faces_resnet_101.pth --num_epochs 20 --latent_dim 3 --resnet_name resnet101
# CUDA_VISIBLE_DEVICES=1 python train_embedder.py --data_dir /data2/akheirandish3/id_new_warped_images/ID_same_base --save_model models/pixel_autoencoder_CT_same_data.pth --num_epochs 20 --latent_dim 3 --resnet_name resnet101
...
parser.add_argument("--latent_dim", type=int, default=3, help="Dimensionality of the latent space in the autoencoder")
